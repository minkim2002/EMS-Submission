                ...
                <Modal className="insertModal" open={this.state.show} onClose={() => { this.handleClear.call(this); this.handleClose(); }} disableBackdropClick={true}>
                    <Paper className="ModalDiv">
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={6} sm={6}>
                                <FormControl variant="outlined" className="selectForm" style={{ width: '100%' }}>
                                    <TextField name="CategoryDesc" className="errorMessage" placeholder="Category Description" value={this.state.EMSCategory.CategoryDesc} onChange={this.handleChange} helperText="Category Description" inputProps={{ maxLength: 250 }} />
                                </FormControl>
                            </Grid>
                            <Grid item xs={3} sm={3}>
