...
export class EMSSubmitUpdatePopup extends React.Component<ComplaintProps, {}>{
    ...
    // send email
    sendEmail = () => {
        this.state.Email.To[0] = this.state.EMSVComplaint.CreatedBy + 'FIRE-EMSSubmission@fairfaxcounty.gov';

        if (this.userId && this.userId.length > 3)
            this.state.Email.CC[0] = 'FIRE-EMSSubmission@fairfaxcounty.gov';
    ...
    setComplaint = () => {
        this.state.EMSComplaint.ComplaintId = this.props.EMSComplaint.ComplaintId;
        ...
        return (
            <Grid item xs={12} style={{ textAlign: "left" }}>
                <Grid container className="textRight alignRight">
                    ...
                    {this.props.PageName === 'Submit' && (this.props.EMSComplaint.ComplaintStatus === 'Completed' || this.props.EMSComplaint.ComplaintStatus === 'Reviewed' || this.props.EMSComplaint.ComplaintStatus === 'Denied') ? null : <React.Fragment><Button variant="contained" color="primary" onClick={() => { this.handleShow(); }} data-toggle="tooltip" title="Update EMS Submission" className="marginLeft5"><img src={window.location.origin + '/images/edit_white.png'} className="btnImage" /></Button>
                        <Button variant='contained' color="secondary" onClick={() => { window.confirm('Are you sure you wish to delete this EMS Submission?') && this.handleDelete.call(this, this.props.EMSComplaint.ComplaintId); }} data-toggle="tooltip" title="Delete EMS Submission" className="marginLeft5"><img src={window.location.origin + '/images/delete_white.png'} className="btnImage" /></Button></React.Fragment>}
                </Grid>
