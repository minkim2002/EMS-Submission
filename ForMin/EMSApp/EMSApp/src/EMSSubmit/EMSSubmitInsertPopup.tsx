...
export class EMSSubmitInsertPopup extends React.Component<ComplaintProps, {}>{
    ...
    //Insert Complaint
    handleSubmit = () => {
        console.log(this.state.EMSComplaint.CategoryId);
                        ...
                        if (this.state.EMSComplaint.Location && this.state.EMSComplaint.Location.length > 1) {
                            if (this.state.EMSComplaint.Unit && this.state.EMSComplaint.Unit.length > 1 || this.state.EMSComplaint.CategoryId === 53) {
                                if ((this.state.EMSComplaint.SerialNumber && this.state.EMSComplaint.SerialNumber.length > 1) || this.state.SerialNumberRequire.indexOf(this.state.EMSComplaint.CategoryId) < 0) {
                                    if ((this.state.EMSComplaint.VehicleNumber && this.state.EMSComplaint.VehicleNumber.length > 1) || this.state.VehicleNumberRequire.indexOf(this.state.EMSComplaint.CategoryId) < 0) {
                    ...
                    <Paper className="ModalDiv">
                        <Grid container spacing={2}>
                            ...
                            <Grid className="textRight" item xs={9}>
                                <h6 className="notification">Click Submit prior to uploading any supplemental documents or images</h6>
                            </Grid>
