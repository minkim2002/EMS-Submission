"use strict";
(self["webpackChunkemsapp"] = self["webpackChunkemsapp"] || []).push([["src_EMSSubmit_EMSDetail_tsx-src_EMSSubmit_EMSSubmitUpdatePopup_tsx"],{
...
var EMSNote = /** @class */ (function (_super) {
    ...
    function EMSNote(props) {
        ...
        _this.getEMSNote = function () {
            var url = (0, emsUtilities_1.baseApiUrl)() + 'EMSNote';
        ...
        return (React.createElement(core_1.Table, null,
            React.createElement(core_1.TableHead, null,
                React.createElement(core_1.TableRow, { style: (this.props.ComplaintId && this.props.ComplaintId > 0) ? {} : { display: 'none' } },
                    ...
                    React.createElement("th", { colSpan: 1, className: "SubTableHeader textRight" },
    ...
    function EMSNoteInsertPopup(props) {
        ...
        _this.insertNote = function () {
            return (React.createElement(core_1.Grid, { item: true, xs: 12, style: { textAlign: "left" } },
                React.createElement(core_1.Grid, { container: true, className: "textRight alignRight", style: { paddingBottom: "5px" } },
                    React.createElement(core_1.Button, { variant: "contained", onClick: function () { _this.handleShow(); }, className: "btnImgInsert marginRight10", "data-toggle": "tooltip", title: "Insert Note" },
...
var EMSNoteUpdatePopup = /** @class */ (function (_super) {
    ...
    function EMSNoteUpdatePopup(props) {
        ...
        _this.insertNote = function () {
            return (React.createElement(core_1.Grid, { item: true, xs: 12, style: { textAlign: "left" } },
                React.createElement(core_1.Grid, { container: true, className: "textRight alignRight", style: { paddingBottom: "5px" } },
                    React.createElement(core_1.Button, { variant: "contained", color: "primary", onClick: function () { _this.handleShow(); }, "data-toggle": "tooltip", title: "Update Log", className: "marginLeft5" },
                        React.createElement("img", { src: window.location.origin + '/images/edit_white.png', className: "btnImage" })),
                    React.createElement(core_1.Button, { variant: 'contained', color: "secondary", onClick: function () { window.confirm('Are you sure you wish to delete this Log?') && _this.handleDelete.call(_this, _this.props.Note.NoteId); }, "data-toggle": "tooltip", title: "Delete Log", className: "marginLeft5" },
...
var EMSDetail = /** @class */ (function (_super) {
    ...
    function EMSDetail(props) {
        ...
        _this.setComplaint = function () {
            console.log(_this.props.EMSVComplaint);
            ...
            console.log(_this.state.EMSVComplaint);
        };
        return _this;
    }
...
var EMSSubmitUpdatePopup = /** @class */ (function (_super) {
    ...
    function EMSSubmitUpdatePopup(props) {
        ...
        _this.state = {
            ...
            show: false, canSave: false, PageName: ''
        };
        _this.eMSSubmitTab = React.createRef();
        ...
        _this.getWorkGroup = function () {
            ...
            fetch(url, emsUtilities_1.getRequestOptions).then(function (res) {
                ...
                console.log(_this.state.WorkGroupList);
            }).catch(function (errors) {
                //console.log(errors);
            });
        };
        ...
        _this.getUnit = function () {
            ...
            fetch(url, emsUtilities_1.getRequestOptions).then(function (res) {
                ...
                console.log(_this.state.UnitList);
            }).catch(function (errors) {
                //console.log(errors);
            });
        };
        ...
        _this.getEMSCategory = function () {
            ...
            fetch(url, emsUtilities_1.getRequestOptions).then(function (res) {
                ...
                console.log(_this.state.EMSCategoryList);
            }).catch(function (errors) {
                //console.log(errors);
            });
        };
        ...
        //Insert Complaint
        _this.handleSubmit = function () {
            if (_this.state.EMSComplaint.Unit && _this.state.EMSComplaint.Unit !== null) {
                if (_this.state.EMSComplaint.SerialNumber.length > 0) {
                    if (_this.state.EMSComplaint.AssetNumber.length > 0) {
                        ...
                        fetch(ComplaintUrl, requestSQOptions).then(function (res) {
                            ...
                            if (responseData === 400)
                                ...
                                alert((0, emsUtilities_1.getSuccessMessage)('a complaint'));
                            }
                        }).catch(function (errors) {
                            // console.log(errors);
        ...
        _this.handleDetailShow = function () {
            _this.props.handleDetailShow.call(_this);
        };
        _this.handleClose = function () {
            _this.setState({ show: false });
        ...
        _this.setComplaint = function () {
            ...
            _this.state.EMSComplaint.UpdatedBy = _this.props.EMSComplaint.UpdatedBy;
        };
        _this.userId = (0, emsUtilities_1.getUserId)();
        return _this;
    }
    EMSSubmitUpdatePopup.prototype.render = function () {
        ...
        return (React.createElement(core_1.Grid, { item: true, xs: 12, style: { textAlign: "left" } },
            React.createElement(core_1.Grid, { container: true, className: "textRight alignRight", style: { paddingBottom: "5px" } },
                React.createElement(core_1.Button, { variant: "contained", onClick: function () { _this.handleDetailShow(); }, "data-toggle": "tooltip", title: "Detail", className: "marginLeft5", style: { backgroundColor: 'orange' } },
                    React.createElement("img", { src: window.location.origin + '/images/MORE_white.png', className: "btnImage" })),
                React.createElement(core_1.Button, { variant: "contained", color: "primary", onClick: function () { _this.handleShow(); }, "data-toggle": "tooltip", title: "Update Log", className: "marginLeft5" },
                    React.createElement("img", { src: window.location.origin + '/images/edit_white.png', className: "btnImage" })),
                React.createElement(core_1.Button, { variant: 'contained', color: "secondary", onClick: function () { window.confirm('Are you sure you wish to delete this Log?') && _this.handleDelete.call(_this, _this.props.EMSComplaint.ComplaintId); }, "data-toggle": "tooltip", title: "Delete Log", className: "marginLeft5" },
                    React.createElement("img", { src: window.location.origin + '/images/delete_white.png', className: "btnImage" }))),
                    ...
                    React.createElement(core_1.Grid, { container: true, spacing: 2 },
                        React.createElement(core_1.Grid, { item: true, xs: 4 },
                            React.createElement(core_1.FormControl, { variant: "outlined", className: "selectForm", style: { width: '100%' } },
                                ...
                                React.createElement(core_1.Select, { labelId: "demo-simple-select-outlined-label", id: "demo-simple-select-outlined", name: "CategoryId", label: "Category", value: this.state.EMSComplaint.CategoryId, onChange: this.handleChange },
                        ...
                        React.createElement(core_1.Grid, { item: true, xs: 4 },
                            React.createElement(core_1.FormControl, { variant: "outlined", className: "selectForm", style: { width: '100%' } },
                                ...
                                React.createElement(core_1.Select, { labelId: "demo-simple-select-outlined-label", id: "demo-simple-select-outlined", name: "SubCategoryId", label: "SubCategory", value: this.state.EMSComplaint.SubCategoryId, onChange: this.handleChange },
                                    React.createElement(core_1.MenuItem, { value: "" },
                                        React.createElement("em", null, "Select One")),
                        ...
                        this.props.PageName && this.props.PageName === 'Admin' ?
                            React.createElement(core_1.Grid, { item: true, xs: 4, sm: 4 },
                                React.createElement(core_1.FormControl, { variant: "outlined", className: "selectForm", style: { width: '100%' } },
                                    React.createElement(core_1.InputLabel, { id: "demo-simple-select-outlined-label" }, "Report Status"),
                                    React.createElement(core_1.Select, { labelId: "demo-simple-select-outlined-label", id: "demo-simple-select-outlined", label: "Report Status", name: "ComplaintStatus", value: this.state.EMSComplaint.ComplaintStatus, onChange: this.handleChange },
                                        React.createElement(core_1.MenuItem, { value: "" },
                                            React.createElement("em", null, "All")),
                                        React.createElement(core_1.MenuItem, { value: "Submitted" }, "Submitted"),
                                        React.createElement(core_1.MenuItem, { value: "Under Review" }, "Under Review"),
                                        React.createElement(core_1.MenuItem, { value: "Reviewed" }, "Reviewed"),
                                        React.createElement(core_1.MenuItem, { value: "Denied" }, "Denied"),
                                        React.createElement(core_1.MenuItem, { value: "Completed" }, "Completed")))) : React.createElement(core_1.Grid, { item: true, xs: 4, sm: 4 }),
                        React.createElement(core_1.Grid, { item: true, xs: 4, sm: 4 },
                            React.createElement(core_1.FormControl, { variant: "outlined", className: "selectForm", style: { width: '100%' } },
                                React.createElement(core_1.InputLabel, { id: "demo-simple-select-outlined-label", style: { fontSize: 13 } }, "*Location"),
                                React.createElement(core_1.Select, { labelId: "demo-simple-select-outlined-label", id: "demo-simple-select-outlined", name: "Location", label: "Location", value: this.state.EMSComplaint.Location, onChange: this.handleChange },
                                    React.createElement(core_1.MenuItem, { value: "" },
                                        React.createElement("em", null, "Select One")),
                                    this.state.WorkGroupList.map(function (item) { return (React.createElement(core_1.MenuItem, { value: item.Id },
                                        React.createElement("em", null, item.WorkGroupName))); })))),
                        React.createElement(core_1.Grid, { item: true, xs: 4, sm: 4 },
                            React.createElement(core_1.FormControl, { variant: "outlined", className: "selectForm", style: { width: '100%' } },
                                React.createElement(core_1.InputLabel, { id: "demo-simple-select-outlined-label", style: { fontSize: 13 } }, "*Shift"),
                                React.createElement(core_1.Select, { labelId: "demo-simple-select-outlined-label", id: "demo-simple-select-outlined", name: "SubmitterShit", label: "Shift", value: this.state.EMSComplaint.SubmitterShit, onChange: this.handleChange },
                        ...
                        React.createElement(core_1.Grid, { item: true, xs: 4, sm: 4 },
                            React.createElement(core_1.FormControl, { variant: "outlined", className: "selectForm", style: { width: '100%' } },
                                ...
                                React.createElement(core_1.Select, { labelId: "demo-simple-select-outlined-label", id: this.state.EMSComplaint.Unit.length > 0 ? '' : 'requiredFieldLabel', name: "Unit", label: "Unit", value: this.state.EMSComplaint.Unit, onChange: this.handleChange },
                                    React.createElement(core_1.MenuItem, { value: "" },
                                        React.createElement("em", null, "Select One")),
                                    this.state.UnitList.map(function (item) { return (React.createElement(core_1.MenuItem, { value: item.Id },
                                        React.createElement("em", null, item.Unit))); })))),
                        React.createElement(core_1.Grid, { item: true, xs: 6, sm: 6 },
                            React.createElement(core_1.TextField, { name: "SerialNumber", id: this.state.EMSComplaint.SerialNumber.length > 0 ? '' : 'requiredFieldLabel', className: "errorMessage", placeholder: "Serial Number", value: this.state.EMSComplaint.SerialNumber, onChange: this.handleChange, helperText: "Serial Number", inputProps: { maxLength: 11 } }),
                        ...
                        React.createElement(core_1.Grid, { item: true, xs: 6, sm: 6 },
                            ...
                            React.createElement("span", { style: { color: 'blue', fontSize: '11px', padding: '1.5px' } })),
                        React.createElement(core_1.Grid, { item: true, xs: 6, sm: 6 },
                            React.createElement(core_1.TextField, { name: "AssetNumber", id: this.state.EMSComplaint.AssetNumber.length > 0 ? '' : 'requiredFieldLabel', className: "errorMessage", placeholder: "County Asset Number", value: this.state.EMSComplaint.AssetNumber, onChange: this.handleChange, helperText: "County Asset Number", inputProps: { maxLength: 10 } }),
                            React.createElement("span", { style: { color: 'blue', fontSize: '11px', padding: '1.5px' } })),
                        React.createElement(core_1.Grid, { item: true, xs: 6, sm: 6 },
                        ...
                        React.createElement(core_1.Grid, { item: true, xs: 12 },
                            ...
                            React.createElement(EMSSubmitTab_1.EMSSubmitTab, { ref: this.eMSSubmitTab, ComplaintId: this.state.EMSComplaint.ComplaintId, PageName: this.props.PageName })),
                        React.createElement(core_1.Grid, { item: true, xs: 12, className: "textRight popupCloseBtn" },
                            React.createElement(core_1.Button, { variant: 'contained', color: "primary", onClick: function () { _this.handleSubmit(); } }, "Update Complaint"),
                            React.createElement(core_1.Button, { variant: 'contained', color: "default", onClick: function () { _this.handleClear(); _this.handleClose(); } }, "Close")))))));
    };
    EMSSubmitUpdatePopup.prototype.componentDidMount = function () {
        this.getEMSCategory();
        this.getWorkGroup();
        this.getUnit();
    };
...
var baseUrl = function () {
    ...
    if (hostname === 'localhost')
        ...
        return protocol + '//' + hostname + '/applications/TransferRequest';
};
...
//# sourceMappingURL=src_EMSSubmit_EMSDetail_tsx-src_EMSSubmit_EMSSubmitUpdatePopup_tsx.bundle.js.map